...
//This is how we add our new function in prototype of object
...
chai = new createuser("chai",15);  
tea = createuser("tea", 150);

chai.increment();  //chai function will not work until we use new keyword
chai.printMe()
...
to the newly created object. If no explicit return value is specified from the constructor, JavaScript 
